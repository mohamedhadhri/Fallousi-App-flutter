...
void setToken() async {
  ...
  Widget build(BuildContext context) {
                      ...
                      child: Container(
                        ...
                        child: CircleAvatar(
                          backgroundImage: NetworkImage(
                              'https://cdn3.iconfinder.com/data/icons/spring-2-1/30/Newborn_Chicken-512.png'),
                          radius:
    ...
    borderRadius: BorderRadius.circular(20),
                    ...
                    Container(
                      // autogroupnbmuXZk (BoLFCmGAZP4DHhi3kPNbmU)
                      margin: EdgeInsets.fromLTRB(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: 3, // Display a maximum of 3 items
                              ...
                              itemBuilder: (context, index) {
                                ...
                                // Build your list item using currentItem

                                return Container(
                                  // autogroupre3krrv (BoLFVAxVTnFhB2vpcaRE3k)
                                  margin: EdgeInsets.fromLTRB(
                    ...
                    Container(
                        // autogroupbf7gs78 (BoLG756LmZQutyLwW6BF7G)
                        margin: EdgeInsets.fromLTRB(
